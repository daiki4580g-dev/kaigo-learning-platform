    ...
    return (
      <main className="min-h-screen bg-slate-50 flex items-center justify-center px-6">
        <div className="rounded-2xl bg-white border shadow-sm p-8 text-center">
          <p className="text-slate-700 font-medium">ログイン状態を確認しています...</p>
        </div>
      </main>
    );
  }
    ...
    <main className="min-h-screen bg-slate-50 px-6 py-10">
      <div className="max-w-6xl mx-auto">
        <div className="rounded-3xl bg-slate-900 text-white p-8 mb-8 shadow-sm">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-3">講義一覧</h1>
          <p className="text-slate-300 leading-7 max-w-3xl">
            転倒予防・腰痛予防に関する全8単元のカリキュラムです。各講義を選択して、動画視聴と確認テストへ進んでください。
          </p>
        </div>
