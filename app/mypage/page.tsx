...
const curriculum = [
  {
    ...
    goal:
      "身体負担軽減や作業姿勢、安全な介助動作を学び、介護現場で実践できるようになる。",
    lessons: [
      "介助動作に必要な身体負担軽減の基礎",
      "利用者介助時の腰部負担軽減実践",
      "安全な介助につながる作業姿勢",
  ...
  },
  {
    ...
    goal:
      "利用者尊厳や身体拘束適正化などを理解し、適切な介護実践につなげる。",
    lessons: [
      "利用者尊厳を守る介助",
      "身体拘束適正化に向けた介助実践",
      "高齢者虐待防止の理解",
  ...
  },
  {
    ...
    chapter: "介護事故予防実践技術",
    goal:
      "介護事故の予防や再発防止について理解し、安全な介護実践につなげる。",
    lessons: [
      "介護事故の理解と予防実践",
      "利用者変化への気づき",
      "報告・共有の実践",
  ...
  },
  {
    ...
    goal:
      "個人情報保護や多職種連携を学び、安全な情報共有を実践できるようになる。",
    lessons: [
      "個人情報保護と介護実践",
      "SNS利用時の情報管理",
      "安全な申し送り",
